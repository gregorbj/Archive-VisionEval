...
CalculateCarbonIntensity <- function(L) {
  ...
  if (DataPresent(L$Year$Azone, "ElectricityCI")) {
    ...
    ElectricityCI <- interpolate(
      EnergyEmissionsDefaults_ls$CarbonIntensity_df$Electricity,
      EnergyEmissionsDefaults_ls$CarbonIntensity_df$Year,
      Year
    )
  ...
  #Biofuel mix
  BiofuelMix_ <-
    interpolateDfVals(EnergyEmissionsDefaults_ls$LdvBiofuelMix_df, Year)
  ...
  if (DataPresent(L$Year$Region, "HhFuelCI")) {
    ...
    HhFuelProp_ <-
      interpolateDfVals(EnergyEmissionsDefaults_ls$HhFuel_df, Year)
  ...
  if (DataPresent(L$Year$Region, "CarSvcFuelCI")) {
    ...
    CarSvcFuelProp_ <-
      interpolateDfVals(EnergyEmissionsDefaults_ls$CarSvcFuel_df, Year)
  ...
  if (DataPresent(L$Year$Region, "ComSvcFuelCI")) {
    ...
    ComSvcFuelProp_ <-
      interpolateDfVals(EnergyEmissionsDefaults_ls$ComSvcFuel_df, Year)
  ...
  #Biofuel mix
  BiofuelMix_ <-
    interpolateDfVals(EnergyEmissionsDefaults_ls$HvyTrkBiofuelMix_df, Year)
  #Heavy truck fuel carbon intensity
  if (DataPresent(L$Year$Region, "HvyTrkFuelCI")) {
    Out_ls$Year$Region$HvyTrkFuelCI <- L$Year$Region$HvyTrkFuelCI
  } else {
    HvyTrkFuelProp_ <-
      interpolateDfVals(EnergyEmissionsDefaults_ls$HvyTrkFuel_df, Year)
  ...
  if (all(sapply(BiofuelDataNames_, function(x) DataPresent(L$Year$Marea, x)))) {
    ...
    BiofuelMix_ <-
      interpolateDfVals(EnergyEmissionsDefaults_ls$TransitBiofuelMix_df, Year)
  ...
  if (all(sapply(FuelPropNames_, function(x) DataPresent(L$Year$Marea, x)))) {
    ...
    VanFuelProp_ <-
      filterOnNames(
        interpolateDfVals(EnergyEmissionsDefaults_ls$TransitFuel_df, Year),
        "Van", Remove_ = "VanProp")
  ...
  if (all(sapply(FuelPropNames_, function(x) DataPresent(L$Year$Marea, x)))) {
    ...
    RailFuelProp_ <-
      filterOnNames(
        interpolateDfVals(
          EnergyEmissionsDefaults_ls$TransitFuel_df, Year),
