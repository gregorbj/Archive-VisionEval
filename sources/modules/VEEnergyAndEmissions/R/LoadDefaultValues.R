...
#LoadDefaultValues.R
#===================
#This module processes default energy and emissions characteristics of different
...
EnergyEmissionsDefaults_ls$CarbonIntensity_df <- CarbonIntensity_df
...
#Add to EnergyEmissionsDefaults_ls and clean up
EnergyEmissionsDefaults_ls$CarSvcFuel_df <- CarSvcFuel_df
...
#Add to EnergyEmissionsDefaults_ls and clean up
EnergyEmissionsDefaults_ls$ComSvcFuel_df <- ComSvcFuel_df
...
#Add to EnergyEmissionsDefaults_ls and clean up
EnergyEmissionsDefaults_ls$HhFuel_df <- HhFuel_df
...
#Add to EnergyEmissionsDefaults_ls and clean up
EnergyEmissionsDefaults_ls$LdvBiofuelMix_df <- LdvBiofuelMix_df
...
for (ty in c("Auto", "LtTrk")) {
  for (pt in c("Icev", "Hev", "Phev", "Bev")) {
    ...
    Char_ <- EnergyEmissionsDefaults_ls$LdvPowertrainCharacteristics_df[[CharName]]
...
#Add to EnergyEmissionsDefaults_ls and clean up
EnergyEmissionsDefaults_ls$HhPowertrain_df <- HhPowertrain_df
...
for (ty in c("Auto", "LtTrk")) {
  for (pt in c("Icev", "Hev", "Bev")) {
    ...
    Char_ <- EnergyEmissionsDefaults_ls$LdvPowertrainCharacteristics_df[[CharName]]
    names(Char_) <- EnergyEmissionsDefaults_ls$LdvPowertrainCharacteristics_df$ModelYear
...
#Add to EnergyEmissionsDefaults_ls and clean up
EnergyEmissionsDefaults_ls$CarSvcPowertrain_df <- CarSvcPowertrain_df
...
#Add to EnergyEmissionsDefaults_ls and clean up
EnergyEmissionsDefaults_ls$ComSvcPowertrain_df <- ComSvcPowertrain_df
rm(Inp_ls, AutoNames_, AutoCols_, LtTrkNames_, LtTrkCols_, Years_, Msg_, ty,
...
#Add to EnergyEmissionsDefaults_ls and clean up
EnergyEmissionsDefaults_ls$HvyTrkFuel_df <- HvyTrkFuel_df
...
#Add to EnergyEmissionsDefaults_ls and clean up
EnergyEmissionsDefaults_ls$HvyTrkBiofuelMix_df <- HvyTrkBiofuelMix_df
...
for (pt in c("Icev", "Hev", "Bev")) {
  ...
  Char_ <- EnergyEmissionsDefaults_ls$HvyTrkPowertrainCharacteristics_df[[CharName]]
  names(Char_) <- EnergyEmissionsDefaults_ls$HvyTrkPowertrainCharacteristics_df$Year
  Char_ <- Char_[names(Prop_)]
  if (any(Prop_[is.na(Char_)] != 0)) {
    Msg <- paste0(
...
#Add to EnergyEmissionsDefaults_ls and clean up
EnergyEmissionsDefaults_ls$HvyTrkPowertrain_df <- HvyTrkPowertrain_df
...
#Add to EnergyEmissionsDefaults_ls and clean up
EnergyEmissionsDefaults_ls$TransitFuel_df <- TransitFuel_df
...
#Add to EnergyEmissionsDefaults_ls and clean up
EnergyEmissionsDefaults_ls$TransitBiofuelMix_df <- TransitBiofuelMix_df
...
#Add to EnergyEmissionsDefaults_ls and clean up
EnergyEmissionsDefaults_ls$TransitPowertrainCharacteristics_df <-
  TransitPowertrainCharacteristics_df
...
for (ty in c("Van", "Bus", "Rail")) {
  for (pt in c("Icev", "Hev", "Bev")) {
    ...
    Char_ <- EnergyEmissionsDefaults_ls$TransitPowertrainCharacteristics_df[[CharName]]
    names(Char_) <- EnergyEmissionsDefaults_ls$TransitPowertrainCharacteristics_df$Year
    Char_ <- Char_[names(Prop_)]
    if (any(Prop_[is.na(Char_)] != 0)) {
      Msg <- paste0(
...
#Add to EnergyEmissionsDefaults_ls and clean up
EnergyEmissionsDefaults_ls$TransitPowertrain_df <- TransitPowertrain_df
...
"EnergyEmissionsDefaults_ls"
devtools::use_data(EnergyEmissionsDefaults_ls, overwrite = TRUE)
rm(EnergyEmissionsDefaults_ls)
