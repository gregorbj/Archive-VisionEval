#==========================
#SplitComSvcDvmtByTypeAge.R
#==========================
# This module splits commercial light-duty DVMT into components by vehicle type
# and age.
...
#' }
#' @source SplitComSvcDvmtByTypeAge.R script.
"LDVehAgeCDF_AgTy"
...
#------------------------------
SplitComSvcDvmtByTypeAgeSpecifications <- list(
  ...
  Inp = items(
    item(
      NAME = items(
        "ComSvcAutoMeanAge",
        "ComSvcLtTrkMeanAge"),
      FILE = "region_comsvc_mean_age.csv",
      TABLE = "Region",
      GROUP = "Year",
      TYPE = "time",
      UNITS = "YR",
...
#---------------------------------
#' Specifications list for SplitComSvcDvmtByTypeAge module
#'
#' A list containing specifications for the SplitComSvcDvmtByTypeAge module.
#'
...
#' }
#' @source SplitComSvcDvmtByTypeAge.R script.
"SplitComSvcDvmtByTypeAgeSpecifications"
devtools::use_data(SplitComSvcDvmtByTypeAgeSpecifications, overwrite = TRUE)
