...
#------------------------------
PredictWalkPMTSpecifications <- list(
...
#---------------------------------
#' Specifications list for PredictWalkPMT module
#'
#' A list containing specifications for the PredictWalkPMT module.
#'
...
#Main module function that predicts WalkPMT for households
#------------------------------------------------------
#' Main module function
#'
#' \code{PredictWalkPMT} predicts WalkPMT for each household in the households
#' dataset using independent variables including household characteristics
#' and 5D built environment variables.
#'
#' This function predicts WalkPMT for each hosuehold in the model region where
#' each household is assigned an WalkPMT. The model objects as a part of the
...
#' for each segment to predict WalkPMT for each household. The vectors of HhId
#' and WalkPMT produced by the PredictWalkPMT function are to be stored in the
#' "Household" table.
#'
