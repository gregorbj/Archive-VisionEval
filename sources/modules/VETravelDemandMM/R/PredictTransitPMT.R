...
#------------------------------
PredictTransitPMTSpecifications <- list(
...
#Main module function that predicts TransitPMT for households
#------------------------------------------------------
#' Main module function
#'
#' \code{PredictTransitPMT} predicts TransitPMT for each household in the households
#' dataset using independent variables including household characteristics
#' and 5D built environment variables.
#'
#' This function predicts TransitPMT for each hosuehold in the model region where
#' each household is assigned an TransitPMT. The model objects as a part of the
...
#' for each segment to predict TransitPMT for each household. The vectors of HhId
#' and TransitPMT produced by the PredictTransitPMT function are to be stored in the
#' "Household" table.
#'
