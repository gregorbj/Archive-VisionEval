...
#' }
#' @source AssignVehicleDvmtSplit.R script.
"VmtSplitModel"
...
#------------------------------
AssignVehicleDvmtSplitSpecifications <- list(
...
#---------------------------------
#' Specifications list for AssignVehicleDvmtSplit module
#'
#' A list containing specifications for the AssignVehicleDvmtSplit module.
#'
...
#' }
#' @source AssignVehicleDvmtSplit.R script.
"AssignVehicleDvmtSplitSpecifications"
devtools::use_data(AssignVehicleDvmtSplitSpecifications, overwrite = TRUE)
...
#'
#' \code{AssignVehicleDvmtSplit} calculate proportions of household DVMT
...
#' @import data.table
#' @export
AssignVehicleDvmtSplit <- function(L) {
