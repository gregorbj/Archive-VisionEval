...
for(Year in getYears()) {
  ...
  runModule("CalculateBaseCommercialDvmt",   "VECommercialTravel",   RunFor = "BaseYear",    RunYear = Year)
  runModule("CalculateFutureCommercialDvmt", "VECommercialTravel",   RunFor = "NotBaseYear", RunYear = Year)
